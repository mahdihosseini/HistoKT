...
python src/adas/train.py --config /home/zhan8425/projects/def-msh/zhan8425/HistoKT/NewPostTrainingConfigs/ADP-Release1/AdamP/None-config.yaml --output MHIST_transformed_norm_MHIST_transformed_color_aug_None_ImageNet/ADP-Release1/AdamP/output/deep_tuning/ --checkpoint MHIST_transformed_norm_MHIST_transformed_color_aug_None_ImageNet/ADP-Release1/AdamP/checkpoint/deep_tuning/lr-0.0001 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-msh/zhan8425/HistoKT/BestImageNet_Weights/MHIST_transformed.pth.tar --freeze_encoder False --save-freq 200 --norm_vals MHIST_transformed 

...
python src/adas/train.py --config ~/projects/def-plato/zhan8425/HistoKT/NewPostTrainingConfigs/MHIST_transformed/AdamP/Color-Distortion-0.2-config.yaml --output ADP_level_1_norm_ADP-Release1/MHIST_transformed/AdamP/output/fine_tuning/Color-Distortion/distortion-0.2 --checkpoint ADP_level_1_norm_ADP-Release1/MHIST_transformed/AdamP/checkpoint/fine_tuning/Color-Distortion/distortion-0.2/lr-0.0005 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-plato/zhan8425/HistoKT/pretrained_weights/ADP-Release1/level_1/best_trial_2_date_2021-07-13-19-43-53.pth.tar --freeze_encoder True --save-freq 200 --color_aug Color-Distortion --norm_vals ADP-Release1

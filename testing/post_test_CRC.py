...
if __name__ == "__main__":
    checkpoint = "/home/zhujiada/projects/def-plato/zhan8425/HistoKT/CRC_post_trained"
    root = "/scratch/zhan8425/HistoKTdata"
    #root = sys.argv[1]
    output = "/home/zhujiada/projects/def-plato/zhujiada/output_CRC_post"  # None if same as the checkpoint dir

    dataset_name_list = ["BCSS_transformed", "ADP", "GlaS_transformed", "AJ-Lymph_transformed", "BACH_transformed", "OSDataset_transformed", "MHIST_transformed","PCam_transformed"]

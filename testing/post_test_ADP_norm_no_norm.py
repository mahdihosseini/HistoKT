...
def test_main(path_to_root, path_to_checkpoint, dataset_name_list, path_to_output=None):
    ...
    for dataset_name in dataset_name_list:
        print("****************************", dataset_name, "****************************")
        transform_test = transforms.Compose([transforms.ToTensor(), transforms.Normalize(mean=[0.0, 0.0, 0.0], std=[1.0, 1.0, 1.0])])
...
if __name__ == "__main__":
    checkpoint = "/home/zhujiada/projects/def-plato/zhan8425/HistoKT/ADP_post_trained_norm_no_norm"
    root = "/scratch/zhan8425/HistoKTdata"
    #root = sys.argv[1]
    output = "/home/zhujiada/projects/def-plato/zhujiada/output_ADP_post_norm_no_norm"  # None if same as the checkpoint dir

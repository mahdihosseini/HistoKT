...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/PCam_transformed_norm_PCam_transformed"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/PCam_transformed_norm_PCam_transformed_output"  # None if same as the checkpoint dir

    dataset_name_list = ["AJ-Lymph_transformed","BACH_transformed","GlaS_transformed","MHIST_transformed"]

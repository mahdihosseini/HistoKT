...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/BACH_transformed_norm_BACH_transformed"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/BACH_transformed_norm_BACH_transformed_output"  # None if same as the checkpoint dir

    dataset_name_list = ["AJ-Lymph_transformed","GlaS_transformed","MHIST_transformed", "PCam_transformed"]

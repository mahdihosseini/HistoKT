...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/BCSS_transformed_norm_BCSS_transformed"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/BCSS_transformed_norm_BCSS_transformed_output"  # None if same as the checkpoint dir

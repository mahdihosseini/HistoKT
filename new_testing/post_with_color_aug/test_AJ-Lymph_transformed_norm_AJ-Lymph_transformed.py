...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/AJ-Lymph_transformed_norm_AJ-Lymph_transformed"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/AJ-Lymph_transformed_norm_AJ-Lymph_transformed_output"  # None if same as the checkpoint dir

    dataset_name_list = ["BACH_transformed","GlaS_transformed","MHIST_transformed", "PCam_transformed"]

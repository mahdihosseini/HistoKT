...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/source/ADP_level_1_norm_ADP-Release1"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ADP_level_1_norm_ADP-Release1_output"  # None if same as the checkpoint dir

    dataset_name_list = ["CRC_transformed", "BCSS_transformed"]

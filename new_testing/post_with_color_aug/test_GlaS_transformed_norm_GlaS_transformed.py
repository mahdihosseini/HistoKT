...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/GlaS_transformed_norm_GlaS_transformed"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/GlaS_transformed_norm_GlaS_transformed_output"  # None if same as the checkpoint dir

    dataset_name_list = ["AJ-Lymph_transformed","BACH_transformed","MHIST_transformed", "PCam_transformed"]

...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/post_training_without_color_aug/CRC_transformed_norm_CRC_transformed_color_aug_None"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/post_without_color_aug/CRC_transformed_norm_CRC_transformed_color_aug_None_output"  # None if same as the checkpoint dir

    dataset_name_list = ["ADP", "AJ-Lymph_transformed", "BACH_transformed", "BCSS_transformed", "GlaS_transformed","MHIST_transformed", "OSDataset_transformed", "PCam_transformed"]

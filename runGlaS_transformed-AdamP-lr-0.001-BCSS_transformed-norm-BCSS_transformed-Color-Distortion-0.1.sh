...
python src/adas/train.py --config /home/zhan8425/projects/def-msh/zhan8425/HistoKT/NewPostTrainingConfigs/GlaS_transformed/AdamP/Color-Distortion-0.1-config.yaml --output BCSS_transformed_norm_BCSS_transformed/GlaS_transformed/AdamP/output/deep_tuning/Color-Distortion/distortion-0.1 --checkpoint BCSS_transformed_norm_BCSS_transformed/GlaS_transformed/AdamP/checkpoint/deep_tuning/Color-Distortion/distortion-0.1/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-msh/zhan8425/HistoKT/best-pretraining-checkpoint/None/BCSS_transformed/best_trial_0_date_2021-07-13-19-36-02.pth.tar --freeze_encoder False --save-freq 200 --color_aug Color-Distortion --norm_vals BCSS_transformed 

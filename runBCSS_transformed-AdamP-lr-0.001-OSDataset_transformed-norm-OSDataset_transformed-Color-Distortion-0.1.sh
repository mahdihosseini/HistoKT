...
python src/adas/train.py --config /home/zhan8425/projects/def-msh/zhan8425/HistoKT/NewPostTrainingConfigs/BCSS_transformed/AdamP/Color-Distortion-0.1-config.yaml --output OSDataset_transformed_norm_OSDataset_transformed/BCSS_transformed/AdamP/output/deep_tuning/Color-Distortion/distortion-0.1 --checkpoint OSDataset_transformed_norm_OSDataset_transformed/BCSS_transformed/AdamP/checkpoint/deep_tuning/Color-Distortion/distortion-0.1/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-msh/zhan8425/HistoKT/best-pretraining-checkpoint/None/OSDataset_transformed/best_trial_2_date_2021-07-13-19-35-33.pth.tar --freeze_encoder False --save-freq 200 --color_aug Color-Distortion --norm_vals OSDataset_transformed 

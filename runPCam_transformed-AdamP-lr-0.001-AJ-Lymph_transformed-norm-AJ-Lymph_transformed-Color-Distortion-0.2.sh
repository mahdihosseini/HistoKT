...
python src/adas/train.py --config /home/zhan8425/projects/def-msh/zhan8425/HistoKT/NewPostTrainingConfigs/PCam_transformed/AdamP/Color-Distortion-0.2-config.yaml --output AJ-Lymph_transformed_norm_AJ-Lymph_transformed/PCam_transformed/AdamP/output/deep_tuning/Color-Distortion/distortion-0.2 --checkpoint AJ-Lymph_transformed_norm_AJ-Lymph_transformed/PCam_transformed/AdamP/checkpoint/deep_tuning/Color-Distortion/distortion-0.2/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-msh/zhan8425/HistoKT/best-pretraining-checkpoint/None/AJ-Lymph_transformed/best_trial_1_date_2021-07-14-04-50-12.pth.tar --freeze_encoder False --save-freq 200 --color_aug Color-Distortion --norm_vals AJ-Lymph_transformed 

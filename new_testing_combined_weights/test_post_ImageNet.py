...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/weight_sharing_preSVD/ImageNet"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/weight_sharing_preSVD/ImageNet"  # None if same as the checkpoint dir

...
def test_main(path_to_root, path_to_checkpoint, dataset_name_list, path_to_output=None):
    ...
    for dataset_name in dataset_name_list:
        ...
        for file in os.listdir(path_to_dataset_cp):
            path_to_dataset_cp = os.path.join(path_to_dataset_cp, file)
...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/ADPL3/ADP-Release1_norm_ADP-Release1_color_aug_None_ADPL3"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ADPL3/ADP"  # None if same as the checkpoint dir

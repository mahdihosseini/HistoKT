...
def test_main(path_to_root, path_to_checkpoint, dataset_name_list, path_to_output=None):
    ...
    for dataset_name in dataset_name_list:
        ...
        path_to_dataset_cp = os.path.join(path_to_dataset_cp, "AdamP/checkpoint/deep_tuning/lr-0.0001")
...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/ADPL3/PCam_transformed_norm_PCam_transformed_color_aug_None_ADPL3"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ADPL3/PCam_transformed"  # None if same as the checkpoint dir

    dataset_name_list = ["ADP"]#, "AJ-Lymph_transformed", "BACH_transformed", "BCSS_transformed", "CRC_transformed", "GlaS_transformed", "MHIST_transformed", "OSDataset_transformed", "PCam_transformed"]

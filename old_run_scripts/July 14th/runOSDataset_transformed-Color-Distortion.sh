...
python src/adas/train.py --config ~/projects/def-plato/zhan8425/HistoKT/PretrainingConfigs/OSDataset_transformed-Color-Distortion-configAdas.yaml --output pretraining-output/Color-Distortion/OSDataset_transformed --checkpoint pretraining-checkpoint/Color-Distortion/OSDataset_transformed --data $SLURM_TMPDIR --save-freq 200

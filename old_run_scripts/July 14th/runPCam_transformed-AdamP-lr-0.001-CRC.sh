...
python src/adas/train.py --config PostTrainingConfigs/PCam_transformed_testing/AdamP/lr-0.001-config-AdamP.yaml --output CRC_post_trained/PCam_transformed/AdamP/output/fine_tuning --checkpoint CRC_post_trained/PCam_transformed/AdamP/checkpoint/fine_tuning/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /project/6060173/zhan8425/HistoKT/pretraining-checkpoint/Color-Distortion/CRC_transformed/best_trial_2_date_2021-07-07-16-50-22.pth.tar --freeze_encoder True --save-freq 200
python src/adas/train.py --config PostTrainingConfigs/PCam_transformed_testing/AdamP/lr-0.001-config-AdamP.yaml --output CRC_post_trained/PCam_transformed/AdamP/output/deep_tuning --checkpoint CRC_post_trained/PCam_transformed/AdamP/checkpoint/deep_tuning/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /project/6060173/zhan8425/HistoKT/pretraining-checkpoint/Color-Distortion/CRC_transformed/best_trial_2_date_2021-07-07-16-50-22.pth.tar --freeze_encoder False --save-freq 200

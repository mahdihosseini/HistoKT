    ...
    for dataset_name in dataset_name_list:
        ...
        transform_test = transforms.Compose([
            ...
            transforms.Normalize(
                mean=transformed_norm_weights["GlaS_transformed"]["mean"],
                std=transformed_norm_weights["GlaS_transformed"]["std"])])
...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/post_training_without_color_aug_ImageNet/GlaS_transformed_norm_GlaS_transformed_color_aug_None_ImageNet"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ImageNet_output/GlaS_transformed_norm_GlaS_transformed_color_aug_None_ImageNet_output"  # None if same as the checkpoint dir

    dataset_name_list = ["CRC_transformed"] #["AJ-Lymph_transformed", "BACH_transformed", "BCSS_transformed", "CRC_transformed", "MHIST_transformed", "OSDataset_transformed", "PCam_transformed"]

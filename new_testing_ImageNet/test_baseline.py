...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/ImageNet_weights/new-ImageNet-pretraining-checkpoint/None"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ImageNet_output/ImageNet_pretrain_output"  # None if same as the checkpoint dir

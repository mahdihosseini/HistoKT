    ...
    for dataset_name in dataset_name_list:
        ...
        transform_test = transforms.Compose([
            ...
            transforms.Normalize(
                mean=transformed_norm_weights["BCSS_transformed"]["mean"],
                std=transformed_norm_weights["BCSS_transformed"]["std"])])
...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/post_training_without_color_aug_ImageNet/BCSS_transformed_norm_BCSS_transformed_color_aug_None_ImageNet"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ImageNet_output/BCSS_transformed_norm_BCSS_transformed_color_aug_None_ImageNet_output"  # None if same as the checkpoint dir

    dataset_name_list = ["ADP", "CRC_transformed"]#["AJ-Lymph_transformed", "BACH_transformed", "MHIST_transformed", "CRC_transformed", "GlaS_transformed", "OSDataset_transformed", "PCam_transformed"]

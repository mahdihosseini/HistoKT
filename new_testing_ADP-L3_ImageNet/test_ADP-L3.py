...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/ADPL3_ImageNet_norm_ImageNet/PCam_transformed_norm_ImageNet_color_aug_None_ADPL3"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ADPL3_ImageNet_norm_ImageNet/PCam_transformed_norm_ImageNet_color_aug_None_ADPL3"  # None if same as the checkpoint dir

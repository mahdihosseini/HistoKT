...
if __name__ == "__main__":
    checkpoint = "/ssd2/HistoKT/results/post_training_without_color_aug_ImageNet_norm_ImageNet/OSDataset_transformed_norm_ImageNet_color_aug_None_ImageNet"
    root = "/ssd2/HistoKT/datasets"
    output = "/ssd2/HistoKT/test/ADPL3_ImageNet_norm_ImageNet/OSDataset_transformed_norm_ImageNet_color_aug_None_ImageNet"  # None if same as the checkpoint dir

    dataset_name_list = ["GlaS_transformed"]

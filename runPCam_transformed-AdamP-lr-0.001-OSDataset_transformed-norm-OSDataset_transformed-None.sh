...
python src/adas/train.py --config /home/zhan8425/projects/def-msh/zhan8425/HistoKT/NewPostTrainingConfigs/PCam_transformed/AdamP/None-config.yaml --output OSDataset_transformed_norm_OSDataset_transformed_color_aug_None_ImageNet/PCam_transformed/AdamP/output/deep_tuning/ --checkpoint OSDataset_transformed_norm_OSDataset_transformed_color_aug_None_ImageNet/PCam_transformed/AdamP/checkpoint/deep_tuning/lr-0.001 --data $SLURM_TMPDIR --pretrained_model /home/zhan8425/projects/def-msh/zhan8425/HistoKT/BestImageNet_Weights/OSDataset_transformed.pth.tar --freeze_encoder False --save-freq 200 --norm_vals OSDataset_transformed 
